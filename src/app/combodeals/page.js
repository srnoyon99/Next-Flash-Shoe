...
const page = () => {
  ...
  const producstname = [
    { name: 'shaker', price: '$4000', oldPrice: '$5000', color: 'Red', color1: 'Blue', color2: 'Green', size: '40', size1: '42', size2: '38' },
    { name: 'shaker', price: '$5500', oldPrice: '$6500', color: 'Red', color1: 'Blue', color2: 'Green', size: '42', size1: '44', size2: '46' },
    { name: 'shaker', price: '$7000', oldPrice: '$8000', color: 'Red', color1: 'Blue', color2: 'Green', size: '38', size1: '44', size2: '46' },
    { name: 'shaker', price: '$3500', oldPrice: '$4500', color: 'Red', color1: 'Blue', color2: 'Green', size: 'M', size1: '44', size2: '46' },
    { name: 'shaker', price: '$4000', oldPrice: '$5000', color: 'Red', color1: 'Blue', color2: 'Green', size: '40', size1: '44', size2: '46' },
    { name: 'shaker', price: '$5500', oldPrice: '$6500', color: 'Red', color1: 'Blue', color2: 'Green', size: '41', size1: '44', size2: '46' },
    { name: 'shaker', price: '$7000', oldPrice: '$8000', color: 'Red', color1: 'Blue', color2: 'Green', size: '38', size1: '44', size2: '46' },
    { name: 'shaker', price: '$3500', oldPrice: '$4500', color: 'Red', color1: 'Blue', color2: 'Green', size: 'M', size1: '44', size2: '46' },
    { name: 'shaker', price: '$4000', oldPrice: '$5000', color: 'Red', color1: 'Blue', color2: 'Green', size: '40', size1: '42', size2: '38' },
    { name: 'shaker', price: '$5500', oldPrice: '$6500', color: 'Red', color1: 'Blue', color2: 'Green', size: '42', size1: '44', size2:'46' },
    { name: 'shaker', price: '$8000', oldPrice: '$9000', color: 'Red', color1: 'Blue', color2: 'Green', size: '38', size1: '44', size2: '46' },
    { name: 'shaker', price:'$4700', oldPrice:'$5700', color: 'Red', color1: 'Blue', color2: 'Green', size: 'M', size1: '44', size2: '46' },
  ]
    ...
    <div className="container mx-auto px-4 py-4">
      ...
      <div className=' flex items-center justify-start gap-2' >
       <Link href={'/'} > <p className=' text-sm cursor-pointer ' >Home</p> </Link>
        ...
        <p className=' text-sm cursor-pointer text-green-700 ' >Combodeals</p>
      </div>
