      ...
      <div>
        ...
        <div className=" inset-0 flex flex-col items-center justify-center bg-opacity-50">
          <div className="relative flex items-center justify-center gap-3 ">
            ...
            <h3 className="text-center text-2xl lg:text-5xl text-gray-800 mt-2text-center font-bold leading-5 text-nowrap bg-clip-text bg-red-500 mt-6">
              Your Discounted Shoe
            </h3>
          </div>
          <p className="text-center text-sm lg:text-lg text-gray-800 mt-2 max-w-full lg:max-w-2xl pt-3">
