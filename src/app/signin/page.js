         ...
         <div className="py-4 max-w-md w-full">
            <div
               ...
               <form className="space-y-6 mt-10">
                  <TextField type="email" id="email" name="email" label="Email" placeholder="you@gmail.com" darkClassName="dark:bg-neutral-700 dark:outline-neutral-600" />
                  <TextField type={isVisible ? "text" : "password"} id="password" name="password" label="Password" placeholder="••••••••" className="relative" darkClassName="dark:bg-neutral-700 dark:outline-neutral-600">
                     <>
                     ...
                     <input type={isVisible ? "text" : "password"} id="password" name="password" placeholder="••••••••" className="px-3 py-2.5 text-sm text-slate-900 rounded-md bg-white w-full outline-1 -outline-offset-1 outline-slate-300 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-600 dark:text-slate-50 dark:bg-neutral-700 dark:outline-neutral-600" required />
                     </>
                  </TextField>
